    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="flex justify-between mb-3">
            	<a href="${pageContext.request.contextPath}/approve/application/page" class=" bg-purple-100 p-2 rounded-md shadow-md">Pending Applications</a>
            	<a href="${pageContext.request.contextPath}/accepted/application/page">Accepted Applications</a>
                 ...
                 <div class="custom-bg rounded-lg p-4 border border-purple-900">
                    <div class="flex justify-between items-center mb-2">
                        <div class="flex items-center">
                            ...
                            <span class="ml-2 text-xs">A new application for the ${application.jobTitle} position has been received from ${application.username}. Please review the application details.</span>
                        </div>
                        <div class="flex space-x-2">
                            <a href="${pageContext.request.contextPath}/application/reject/${application.applicationId}/${application.jobId}"  class="bg-gray-300 hover:bg-gray-400 py-2 px-4 rounded-md text-xs">Decline</a>
                            <a href="${pageContext.request.contextPath}/application/approve/${application.applicationId}/${application.jobId}" class="custom-bg1 hover:bg-blue-700  py-2 px-4 rounded-md text-xs text-white">Approve</a>
                        </div>
                    </div>
                    <div class="ml-5">
