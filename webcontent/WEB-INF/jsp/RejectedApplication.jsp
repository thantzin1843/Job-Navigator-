    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="flex justify-between mb-3">
            	...
            	<a href="${pageContext.request.contextPath}/rejected/application/page" class=" bg-purple-100 p-2 rounded-md shadow-md">Rejected Applications</a>
            </div>
                 ...
                 <div class="custom-bg rounded-lg p-4 border border-purple-900">
                    <div class="flex justify-between items-center mb-2">
                        <div class="flex items-center">
                            ...
                            <span class="ml-2 text-xs">An application for the ${application.jobTitle} position received from ${application.username} was rejected. Please review the application details.</span>
                        </div>
