    ...
    <div class="container max-w-screen-xl mx-auto ">
        ...
        <div id="alertBox" class=" fixed inset-0 flex justify-center items-center bg-[#E6E6FA]">
            <div class="glass-effect p-6 rounded-xl shadow-lg max-w-sm w-full text-center">
              <h2 class="text-xl font-bold text-black">🎉 Your Job has been posted Successfully </h2>
              <p class="text-black mt-4">The jobseekers will review your post and apply for job if they want!
                <br><br>
                Good luck and thank you for your interest.</p>
              <a href="/Final_JN/post_confirm"><button class="mt-6 px-4 py-2 bg-[#7905EE] text-white rounded-lg">OK </button></a>
          </div>
